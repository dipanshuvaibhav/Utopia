...
app.post("/ajax/email", function(request, response) {
  // create reusable transporter object using the default SMTP transport
	const transporter = nodemailer.createTransport({
		...
		secure: true,
		auth: {
			user: "vidhisaxena1411@gmail.com", // this should be YOUR GMAIL account
			pass: "Threeplusfour@1411" // this should be your password
		}
	});
	...
	var mail = {
		from: "vidhisaxena1411@gmail.com", // sender address
		to: "vidhisaxena1411@gmail.com", // list of receivers (THIS COULD BE A DIFFERENT ADDRESS or ADDRESSES SEPARATED BY COMMAS)
